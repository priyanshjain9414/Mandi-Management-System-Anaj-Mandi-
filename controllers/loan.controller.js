...
module.exports.create = async (req, res) => {
  ...
  try {
    ...
    /* ======================================
         1. FETCH / CREATE GLOBAL LOAN SUMMARY
      ====================================== */
    ...
    /* ======================================
         2. UPDATE GLOBAL LOAN SUMMARY (MASTER)
         ❌ NO INTEREST CALCULATION HERE
      ====================================== */
...
module.exports.farmerLoans = async (req, res) => {
  ...
  // ===== SETTLED LOANS SUMMARY (BOTTOM CARD) =====
...
module.exports.payment = async (req, res) => {
  ...
  try {
    ...
    for (const loan of loans) {
      ...
      // ✅ SAVE TRANSACTION SNAPSHOT (BEFORE UPDATE)
      paymentDetails.push({
        loanId: loan._id,
