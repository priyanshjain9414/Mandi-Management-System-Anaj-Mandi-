...
module.exports.payment = async (req, res) => {
  ...
  ================================ */
    ...
    /* =================================================
         CASE 1: DEALER → FARMER (Crop > Loan)
         ================================================= */
    if (settlementDirection === "DEALER_TO_FARMER") {
      // Finish ALL loans using crop surplus
      ...
      // Paid amount goes ONLY to crops
    ...
    /* =================================================
         CASE 2: FARMER → DEALER (Loan > Crop)
         ================================================= */
    if (settlementDirection === "FARMER_TO_DEALER") {
      // Finish ALL crops first
      for (const crop of crops) {
        const pendingBefore = crop.pendingAmount;
      ...
      // Paid amount goes ONLY to loans
      for (const loan of loans) {
        if (payAmount <= 0) break;
    ...
    /* =================================================
         CASE 3: FULLY SETTLED (Crop === Loan)
         ================================================= */
